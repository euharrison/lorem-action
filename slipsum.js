...
function slipsum() {
    var a = "";
    var b = document.getElementById('para').value;
    for (var i = 0; i < b; i++) {
        rnd_number = Math.floor(Math.random() * diff + min_num);
        if (document.getElementById('ht').value != "none") {
            a += "<" + document.getElementById('ht').value + ">";
    ...
    var c = "<!-- start slipsum code -->\n\n" + a + "<!-- end slipsum code -->";
    document.getElementById('slipsumcode').value = c
}